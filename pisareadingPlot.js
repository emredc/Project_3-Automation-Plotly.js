var pisaReading = {
    ...
    type: "bar",
    marker:{
      color: ['rgba(0, 153, 0, 1)', 'rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 153, 0, 1)','rgba(0, 204, 0, 1)','rgba(0, 204, 0, 1)','rgba(0, 204, 0, 1)', 'rgba(0, 204, 0, 1)', 'rgba(0, 204, 0, 1)', 'rgba(0, 204, 0, 1)','rgba(0, 204, 0, 1)','rgba(0, 204, 0, 1)','rgba(0, 204, 0, 1)','rgba(0, 204, 0, 1)','rgba(0, 204, 0, 1)', 'rgba(96, 96, 96, 1)', 'rgba(204, 204, 0, 1)','rgba(204, 204, 0, 1)',
      'rgba(204,204,0,1)',
